...
public class SoundsRepository {
	...
	public static String BACKGROUND_THEME = "musica-volumen-bajo.wav";
	public static String MISSILE = "missile.wav";
	public static String PHOTON = "photon.wav";
	public static String EXPLOSION = "explosion-volumen-alto.wav";
	...
	public SoundsRepository() {
		...
		this.getAudioClip(BACKGROUND_THEME);
		this.getAudioClip(MISSILE);
		this.getAudioClip(PHOTON);
