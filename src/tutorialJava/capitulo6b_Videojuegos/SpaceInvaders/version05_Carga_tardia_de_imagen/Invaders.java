package tutorialJava.capitulo6b_Videojuegos.SpaceInvaders.version05_Carga_tardia_de_imagen;
...
public class Invaders extends Canvas {
	...
	// Variable en la que almacenamos una imagen del disco duro
	private BufferedImage bicho = null;
	...
	public void paint(Graphics g) {
		...
		// Si la imagen del bicho no está cargada, se carga, en caso contrario
		// ya estaría cargada y no sería necesario volver a hacerlo. Se ganaría
		// mucha velocidad
		if (bicho==null) {
			bicho = loadImage("../res/bicho.gif");
		}
		// Pinto el monstruo en la posición que le corresponde
		g.drawImage(bicho, 100, 100,this);
	}
