package tutorialJava.capitulo6b_Videojuegos.SpaceInvaders.version08_Limpiando_la_escena;
...
public class Invaders extends Canvas {
	...
	public void updateWorld() {
		this.monsterX = (int)(Math.random() * this.getWidth()); // Actualizo la posición del monstruo
		this.monsterY = (int)(Math.random() * this.getHeight()); // Actualizo la posición del monstruo
	}
