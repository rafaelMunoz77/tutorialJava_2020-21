...
public class Monster extends Actor {
	...
	public void fire() {
		...
		// Lanzo el sonido que corresponde a que el Monstruo dispare
	   	SoundsRepository.getInstance().playSound(SoundsRepository.getInstance().PHOTON);	
	}
	...
	public void collisionWith(Actor actorCollisioned) {
		...
		if (actorCollisioned instanceof Missile || actorCollisioned instanceof Bomb) {
			...
			// Lanzo el sonido que corresponde a una explosión
