package tutorialJava.capitulo6b_Videojuegos.SpaceInvaders.version03_Primeros_pegotes;
...
public class Invaders extends Canvas {
	...
	public void paint(Graphics g) {
		...
		// Pinto un círculo de color naranja centrado sobre el canvas
		g.setColor(Color.ORANGE);
		int diametro = 120;
		g.fillOval(this.getWidth() / 2 - diametro / 2, 
				this.getHeight() / 2 - diametro / 2, 
				diametro, diametro);
	}
