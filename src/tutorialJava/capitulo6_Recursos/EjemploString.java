...
public class EjemploString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Remplazo de todas las vocales a través de expresión regular: " + str.replaceAll("[aeiou]", "�"));
		...
		System.out.println("Separación de una cadena en otras cadenas a trav�s de la expresión regular [adt]");
